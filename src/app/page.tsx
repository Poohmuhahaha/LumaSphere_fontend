...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <RotatingMoon />
      <HeroSection />
      <FeaturedArticles isLoading={isLoading} articles={articles} />
      <OceanLayer />
    </main>
  );
}
...
function FeaturedArticles({ isLoading, articles }) {
  return (
...
function LoadingCard() {
  return (
    <Card className="animate-pulse bg-[#1B1B3A] rounded-2xl shadow-inner">
      <CardHeader>
